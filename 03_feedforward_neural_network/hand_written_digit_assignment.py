...
# Create a batch size for images, can start with 10 or 50 or 100
...
# Define the optimizer and loss function. Choosing a smaller learning rate will make it the training run longer
...
# Graph the losses at each epoch. Need to convert tensors to np array, otherwise we get below error
